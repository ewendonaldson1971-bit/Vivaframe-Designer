...
export default function Designer() {
  ...
  async function importDesign(file?:File){if(!file)return;const data=JSON.parse(await file.text());setDesign(data.design);setStartPlaced(true);setProfile(data.productIds?.profile||"ss25");setFinish(data.productIds?.finish||"natural-anodised");}
