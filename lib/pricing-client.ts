...
export function quoteVivaFrame(takeoff:PricingTakeoff){ if(!window.VivaluxPricing)return Promise.reject(new Error("Pricing is provided by Vivalux Builder.")); return window.VivaluxPricing.quote(PRODUCT_KEY,takeoff); }
